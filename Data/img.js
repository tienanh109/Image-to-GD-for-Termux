...
Jimp.read("./" + file).then(async img => {
    ...
    if (imageSize > 100000) console.log("Program by GDColon & tienanh109 ! Works well on images with small pixels (Pixel art)...")
    console.log(`Scanning ${file} ${imageSize > 10000 ? `(${imageSize} pixels, this may take a ${imageSize > 69420 ? "very long time, please wait!" : "while"})` : ""}`)
    ...
    console.log("Converting to GD level and saved in ./Save/...")
    let levelStr = ""
    let objCount = 0
    ...
    fs.readFile(gdLevels, 'utf8', function(err, saveData) {
        ...
        console.log("Importing to GD Level Data...")
        ...
        console.log(`Saved to ./Save/ with (${pixelCount} pixels -> ${objCount} objects)`);
        console.log(`Run Main.sh and choose 3 to export your data ! Script by Tienanh109 & GDColon`);
    })
